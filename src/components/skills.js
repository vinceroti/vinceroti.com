    ...
    return (
      <div style={styles.skills} id="skills">
        ...
        <Accordion  style={styles.accordion}>
          ...
          RSpec is ruby's testing suite. At Dev Bootcamp, testing always came first so for every webapp I made and console app there was always tests that came along with it.
          </Panel>
          <Panel header="OSX" eventKey="17">
          I am very familar with the Mac OS and am comfortable put into a Mac environment.
          </Panel>
        </Accordion>
        <Accordion  style={{...styles.accordion, ...styles.align}}>
          <Panel header="Rails" eventKey="2">
          Ruby on Rails, or simply Rails, is a server-side web application framework written in Ruby Rails is a model–view–controller (MVC) framework, providing default structures for a database, a web service, and web pages. One of the last three weeks at Dev Bootcamp consisted of developing and testing in the Rails framework.
          </Panel>
          <Panel header="CSS" eventKey="4">
          Having well designed and responsive web pages is one of the first thing's you have to keep in mind when building a web site. CSS allows me to do that and is one of the core tool's for web development.
          </Panel>
          ...
          My current laptop is 100% Ubuntu and is my current favorite OS. Not to say I don't enjoy OSX, but I really love my laptop.
          </Panel>
        </Accordion>
